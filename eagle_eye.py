...
def calculate_social_distancing(vid_path, net, output_dir, output_vid, ln1):
    ...
    output_movie = cv2.VideoWriter("./output_vid/distancing.mp4", fourcc, fps, (width, height))
    bird_movie = cv2.VideoWriter("./output_vid/bird_eye_view.mp4", fourcc, fps, (int(width * scale_w), int(height * scale_h)))
...
if __name__== "__main__":
    ...
    parser.add_argument('-v', '--video_path', action='store', dest='video_path', default='./data/vid_short.mp4' ,
